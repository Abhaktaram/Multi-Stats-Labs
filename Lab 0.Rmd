...
wide = read_csv ("Lab0_wide.csv") # Data is already been read in, only need to run this line if it hasn't been stored 
summary(wide) 
...
# Question 5: 5. In question 4, you used the longitudinal data in the wider format. This format is nice for computing summary statistics associated with the outcome over time and time invariant patient level variables.  However, the data is often required to be in the longer format for plotting or fitting regression models.  
